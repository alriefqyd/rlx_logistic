                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        ...
                        <?php $__currentLoopData = $layanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="odd pointer">
                                ...
                                <td class=""><?php echo e($l->price); ?></td>
                                <td class=""><?php echo e($l->description); ?></td>
                                <td class=""><?php echo e($l->created_at); ?></td>
                            </tr>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alriefqydasmito/Project/laravel/rlx_logistic/resources/views/admin/layanan/list.blade.php ENDPATH**/ ?>