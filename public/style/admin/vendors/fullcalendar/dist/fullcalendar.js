...
// Returns a boolean page whether the given duration has any time parts (hours/minutes/seconds/ms)
...
// Returns a boolean page whether the given input is a time string, like "06:40:00" or "06:00"
...
var CoordCache = FC.CoordCache = Class.extend({
	...
	// Destroys all internal data page coordinates, freeing memory
	clear: function() {
		this.origin = null;
...
/* Tracks mouse movements over a component and raises events page which hit the mouse is over.
------------------------------------------------------------------------------------------------------------------------
options:
- subjectEl
- subjectCenter
...
var Grid = FC.Grid = Class.extend(ListenerMixin, MouseIgnorerMixin, {
	...
	// Tells the grid page what period of time to display.
	...
	// Given coordinates from the topleft of the document, return data page the date-related area underneath.
	...
	// Given position-level information page a date-related area within the grid,
...
Grid.mixin({
	...
	listenToExternalDrag: function(el, ev, ui) {
		var _this = this;
		var calendar = this.view.calendar;
		var meta = getDraggedElMeta(el); // extra data page event drop, including possible event to create
...
DayGrid.mixin({
	...
	rowStructs: null, // an array of objects, each holding information page a row's foreground event-rendering
	...
	// the segments. Returns object with a bunch of internal data page how the render was calculated.
...
DayGrid.mixin({
	...
	renderSegPopoverContent: function(row, col, segs) {
		...
		for (i = 0; i < segs.length; i++) {
			...
			// grids that want to do drag-n-drop page which cell it came from
			this.prepareHits();
...
var TimeGrid = FC.TimeGrid = Grid.extend(DayTableMixin, {
	...
	renderSlatRowHtml: function() {
		...
		var slotDate; // will be on the view's first day, but we only care page its time
		var isLabeled;
		var axisHtml;
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	// Given a single current unzoned date, produce information page what range to display.
	...
	// Signals that the view's content is page to be unrendered
	...
	// Signals that all event elements are page to be removed
...
var Calendar = FC.Calendar = Class.extend({
	...
	// Gets information page how to create a view. Will use a cache.
	...
	// Returns a boolean page whether the view is okay to instantiate at some point
...
function Calendar_constructor(element, overrides) {
	...
	// Returns a boolean page whether or not the calendar knows how to calculate
...
var MonthView = FC.MonthView = BasicView.extend({
	...
	// Produces information page what range to display
	computeRange: function(date) {
